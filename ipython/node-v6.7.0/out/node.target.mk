...
$(OBJS): | $(obj).host/node_js2c.stamp $(obj).target/deps/v8/tools/gyp/v8.stamp $(builddir)/libv8_libplatform.a $(builddir)/libicui18n.a $(obj).target/tools/icu/icuuc.stamp $(builddir)/libv8_inspector_stl.a $(builddir)/libopenssl.a $(builddir)/openssl-cli $(obj).target/node_dtrace_header.stamp $(obj).target/specialize_node_d.stamp $(obj).target/deps/v8/tools/gyp/postmortem-metadata.stamp $(builddir)/libzlib.a $(builddir)/libhttp_parser.a $(builddir)/libcares.a $(builddir)/libuv.a $(obj).target/deps/v8/tools/gyp/v8_maybe_snapshot.stamp $(builddir)/libv8_base.a $(builddir)/libv8_libbase.a $(builddir)/libicuucx.a $(obj).target/tools/icu/icu_implementation.stamp $(obj).target/tools/icu/icu_uconfig.stamp $(obj).target/tools/icu/icu_uconfig_target.stamp $(builddir)/libicudata.a $(builddir)/libicustubdata.a $(builddir)/libv8_snapshot.a $(obj).target/deps/v8/tools/gyp/js2c.stamp $(obj).target/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector/inspector_injected_script.stamp $(obj).target/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector/inspector_debugger_script.stamp $(obj).target/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector/protocol_sources_stl.stamp $(obj).target/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector/protocol_version.stamp
...
$(builddir)/node: LD_INPUTS := $(OBJS) $(builddir)/libv8_libplatform.a $(builddir)/libicui18n.a $(builddir)/libv8_inspector_stl.a $(builddir)/libopenssl.a $(builddir)/libzlib.a $(builddir)/libhttp_parser.a $(builddir)/libcares.a $(builddir)/libuv.a $(builddir)/libv8_base.a $(builddir)/libv8_libbase.a $(builddir)/libicuucx.a $(builddir)/libicudata.a $(builddir)/libicustubdata.a $(builddir)/libv8_snapshot.a
$(builddir)/node: TOOLSET := $(TOOLSET)
$(builddir)/node: $(OBJS) $(builddir)/libv8_libplatform.a $(builddir)/libicui18n.a $(builddir)/libv8_inspector_stl.a $(builddir)/libopenssl.a $(builddir)/libzlib.a $(builddir)/libhttp_parser.a $(builddir)/libcares.a $(builddir)/libuv.a $(builddir)/libv8_base.a $(builddir)/libv8_libbase.a $(builddir)/libicuucx.a $(builddir)/libicudata.a $(builddir)/libicustubdata.a $(builddir)/libv8_snapshot.a FORCE_DO_CMD
	$(call do_cmd,link)
